...
if( !defined( 'WTWP_VERSION' ) ) {
	define( 'WTWP_VERSION', '3.0.6' ); // Version of plugin
}
...
if(!defined( 'WTWP_PLUGIN_BUNDLE_LINK' ) ) {
	define('WTWP_PLUGIN_BUNDLE_LINK','https://www.essentialplugin.com/wordpress-plugin/wp-testimonial-with-widget/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Bundle-Banner#wpos-epb'); // Plugin link
}

if(!defined( 'WTWP_PLUGIN_LINK_UNLOCK' ) ) {
	define('WTWP_PLUGIN_LINK_UNLOCK','https://www.essentialplugin.com/wordpress-plugin/wp-testimonial-with-widget/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Features-PRO'); // Plugin link
}

if(!defined( 'WTWP_PLUGIN_LINK_UPGRADE' ) ) {
	define('WTWP_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/wp-testimonial-with-widget/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
