...
<div class="wrap wptww-wrap">
	...
	<h2 class="text-center"><?php _e( 'Testimonials with ', 'wp-testimonial-with-widget' ); ?><span class="h-blue"><?php _e( 'Essential Plugin Bundle Free Trial', 'wp-testimonial-with-widget' ); ?></span></h2>
